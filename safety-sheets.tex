...
Please write down the electricity use (kWh counter) and pay \euro{0.25}/kWh to the foundation (NL30 TRIO 0197 6945 19).
}{
...
\prohib{75}{No Lookie}{The openings (e.g. at the top) are not for looking through. They are for exhaust and temperature measurements. The hot air of 800\degree{}C-1200\degree{}C will damage your eye.}
\warn{118}{Bare electric wires inside}{Do not open the oven while powered on. The heating spirals are not isolated.}
\action{49}{Stay with the machine}{Stay with the machine during the first hour or so}
\action{49}{Be present when the heating is supposed to finish}{You MUST be at the machine when it is near finished heating or check within one or two hours thereafter.}
}{
Stay with the machine during the first few hours. 
Be present when it us supposed to finish (or soon thereafter) -- as the machine lacks an extra safety mechanism and may not shut down properly.
}
...
\action{49}{Keep the door closed}{To keep the dust under control}
...
\warn{117}{Slippery surface}{Floor will get very slippery; especially when using coolant.}
{
\vfill Clean after use -- especially when you have used coolant or have used metals that can rust easily or cause a galvanic reaction. 
...
\machinePage{Sandblasting cabinet}{Mandatory}{

Check that you have switched on dust extraction and the air compressor prior to use.

If blasting sands/beads spills; clean this up with a vacuum cleaner with HEPA filter; and be careful to contain the (harmful) dust. Do \emph{not} blow it into the air; e.g. with the air pressure gun.

}{
\action{49}{Dust extraction mandatory}{Use the dust extractor. Always.}
\action{49}{Keep the cabinet closed during use}{Keep the door wel closed during blasting. Aways. No exception; also not when you have something big.}
\action{64}{Wear a mask}{And wearing a mask is mandatory when changing the sand/granules.}
\action{52}{Eye protection recommended}{And recommended when changing the sand/granules.}
\action{57}{Protective gloves mandatory}{And be careful about hitting the gloves with the sandblast. Do not aim the pistol at your hands.}
\action{49}{Do not aim the pistol at your gloves}{It will blast through. That hurts.}
{
\vfill 
\textbf{Caution when changing the beads}

Do not replace the blasting media yourself if you are not authorized to do so. Ask on the mailing list if an authorized person can do this for you.

Blasting media during use breaks down and generates fine, sharp dust particles. These tiny particles are classified as fine dust, are harmful when inhaled, and require respiratory protection. 

Airborne blast media can be dangerous. It can escape the cabinet
through all the small cracks and holes in the cabinet, especially at the
edges of doors and glove holes.
}
}
