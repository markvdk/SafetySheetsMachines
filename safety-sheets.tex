...
\warn{118}{Stay with the machine}{Stay with the machine during the first hour or so}
\warn{118}{Be present when the heating is supposed to finish}{You MUST be at the machine when it is near finished heating or check within one or two hours thereafter.}
}{
